...
lesson: "Module 6: Context Quality and Debugging — Study Guide"
type: "course_lesson"
post_id: 106578140
space_id: 24391596
source: "https://the-faction.mn.co/posts/106578140"
updated: "2026-08-28T15:47:42Z"
---
...
1. "Here is a bad output and its request ID. Pull the logged window and walk the four failure families: stale, contradictory, displaced, or missing."
1. "Diff the assembled contexts for these two request IDs, same query, different quality, and summarize every difference by layer."
1. "Scan this system prompt against our injected document templates and memory formats, and list every place they can contradict each other."
1. "Run a context audit on 20 random production requests: for each, report what the window contained versus what our recipe says it should contain."

## Common Mistakes

1. Blaming the model and re-rolling until the output looks better, learning nothing about the cause.
1. Prompt-tweaking around a context bug, which adds instruction clutter and often new contradictions.
1. Logging only the user message and the output, leaving the actual model input a mystery.
1. Fixing individual bugs while skipping audits, so systemic rot accumulates underneath the patches.
1. Treating retrieval metrics as a launch gate instead of a scheduled, ongoing check.
1. Ignoring contradiction bugs because output stays fluent while the model quietly picks a side.
...
---
_Source: https://the-faction.mn.co/posts/106578140_
