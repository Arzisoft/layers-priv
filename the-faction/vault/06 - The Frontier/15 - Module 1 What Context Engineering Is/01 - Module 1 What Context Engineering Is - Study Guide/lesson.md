...
lesson: "Module 1: What Context Engineering Is — Study Guide"
type: "course_lesson"
post_id: 106578120
space_id: 24391596
source: "https://the-faction.mn.co/posts/106578120"
updated: "2026-08-28T15:46:42Z"
---
...
1. "Direct the app to log the complete assembled context for every model call, with a label and token count for each layer."
1. "Here are two runs with different outputs from the same prompt. Diff the two assembled contexts and identify what changed."
1. "Restructure this context so standing instructions come first, retrieved documents are clearly delimited, and the user question appears last."
1. "Audit this system prompt for statements that conflict with the retrieved documents we typically inject, and flag every contradiction."

## Common Mistakes

1. Rewriting the prompt when the context is the problem, then concluding the model is unreliable.
1. Assuming the model knows things about your app or user that were never placed in the window.
1. Letting frameworks assemble context invisibly and never logging what the model actually received.
1. Stuffing everything available into the window on the theory that more information always helps.
1. Ignoring ordering, so critical instructions sit buried under pages of retrieved text.
1. Treating context engineering and prompt engineering as rivals instead of designing them together.
...
---
_Source: https://the-faction.mn.co/posts/106578120_
