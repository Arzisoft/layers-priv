...
source: "https://the-faction.mn.co/posts/105993281"
---

# Your RAG system has zero access boundaries. Every document sits in one vector po

Your RAG system has zero access boundaries. Every document sits in one vector pool. When retrieval runs, it pulls the most relevant chunks regardless of who owns them. Today I walk through permission-scoped retrieval, prompt injection filtering, and output verification. If you are building anything with RAG, this is critical.

**PROMPT:** Direct your AI: "RAG security audit: permission-scoped retrieval with ownership tagging, pre-embedding prompt injection scan, and post-retrieval access verification on every response."
