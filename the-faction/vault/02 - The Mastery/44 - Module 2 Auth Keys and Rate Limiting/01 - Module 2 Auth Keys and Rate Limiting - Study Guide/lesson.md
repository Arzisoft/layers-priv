...
lesson: "Module 2: Auth Keys and Rate Limiting — Study Guide"
type: "course_lesson"
post_id: 106571070
space_id: 24191170
source: "https://the-faction.mn.co/posts/106571070"
updated: "2026-08-28T15:43:31Z"
---
...
1. API keys vs OAuth tokens and when each applies
1. Per-key rate limiting enforced at the edge
1. Usage tiers as key configuration, not code changes
1. Key scoping and least privilege
1. IP allowlisting and containing a leaked key
1. Abuse detection patterns
1. Making rate limits transparent through headers, docs, and errors
...
---
_Source: https://the-faction.mn.co/posts/106571070_
