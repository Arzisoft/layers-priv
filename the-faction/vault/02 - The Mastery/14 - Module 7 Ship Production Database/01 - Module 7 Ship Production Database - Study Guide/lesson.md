...
lesson: "Module 7: Ship: Production Database — Study Guide"
type: "course_lesson"
post_id: 105098098
space_id: 24191170
source: "https://the-faction.mn.co/posts/105098098"
...
1. What makes production different, and the data's existential relationship to the business
1. The pre-launch checklist and proving backups by restore into a separate environment
1. Least-privilege app connections, named human access, and secret rotation
1. Removing standing AI write access, and agents as powerful hands within guardrails
1. Monitoring's four questions, investigating anomalies, and schema matching migration history
1. Change through process: staging tests, reviews, rollback plans, logged fixes, planned backfills
1. Incident readiness: drilled runbooks, communication over silence, blameless postmortems
1. Long-term health through routine care, and "boring" as the goal state
...
Ready? Take the [Ship: Production Database Exam →](https://the-faction.mn.co/posts/the-mastery-module-7-ship-production-database-exam)

---
_Source: https://the-faction.mn.co/posts/105098098_
