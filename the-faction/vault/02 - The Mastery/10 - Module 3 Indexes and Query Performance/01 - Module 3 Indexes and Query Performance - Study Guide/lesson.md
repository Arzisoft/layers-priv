...
lesson: "Module 3: Indexes and Query Performance — Study Guide"
type: "course_lesson"
post_id: 105097456
space_id: 24191170
source: "https://the-faction.mn.co/posts/105097456"
...
1. Choosing index candidates: filtered, joined, and sorted columns, especially foreign keys
1. Full table scans, execution plans, and why growth makes unchanged queries slow
1. The N+1 problem and set-based query fixes for query-storm pages
1. Composite indexes and when they beat separate single-column indexes
1. Degradation patterns: production data size, deep pagination, SELECT *, index-defeating query shapes
1. Caching trade-offs, and moving heavy reporting onto replicas or analytics copies
1. Measurement discipline: slow-query logging, post-release metrics, before-and-after evidence
...
Ready? Take the [Indexes and Query Performance Exam →](https://the-faction.mn.co/posts/the-mastery-module-3-indexes-and-query-performance-exam)

---
_Source: https://the-faction.mn.co/posts/105097456_
