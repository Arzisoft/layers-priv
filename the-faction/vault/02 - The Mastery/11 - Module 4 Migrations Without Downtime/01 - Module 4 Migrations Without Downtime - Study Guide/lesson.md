...
lesson: "Module 4: Migrations Without Downtime — Study Guide"
type: "course_lesson"
post_id: 105097574
space_id: 24191170
source: "https://the-faction.mn.co/posts/105097574"
...
1. Why live schema changes risk downtime, and which changes are safely additive
1. The expand-contract pattern and the safe sequence for renaming a live column
1. Backfills, why they run in small batches, and splitting oversized migrations
1. Code compatibility with both structures during rollout, and expand-code-contract ordering
1. Staging tests on production-like data, rollback plans, and pre-change backups
1. Drop discipline, evidence of non-use, hand-applied changes, and schema drift
1. Post-migration verification and the surgeon's mindset for structural change
...
Ready? Take the [Migrations Without Downtime Exam →](https://the-faction.mn.co/posts/the-mastery-module-4-migrations-without-downtime-exam)

---
_Source: https://the-faction.mn.co/posts/105097574_
