...
lesson: "Module 7: Ship: Production Auth — Study Guide"
type: "course_lesson"
post_id: 105099107
space_id: 24191170
source: "https://the-faction.mn.co/posts/105099107"
...
1. The pre-launch checklist and removing test accounts, backdoors, and debug flags
1. Secret handling, scheduled rotation, and the real key rotation sequence
1. Edge rate limiting, shared session stores across servers, and staging discipline
1. Monitoring targets, baselines, and the rule for what logs may contain
1. Incident response: credential stuffing, confirmed exposure, and library vulnerabilities
1. Rollout of significant auth changes: flags, rollback, and monitored migration
1. Access control on production dashboards, support procedures, and security testing evidence
1. Periodic reviews, compliance basics, provider outage planning, and verifying AI claims with evidence
...
Ready? Take the [Ship: Production Auth Exam →](https://the-faction.mn.co/posts/the-mastery-module-7-ship-production-auth-exam)

---
_Source: https://the-faction.mn.co/posts/105099107_
