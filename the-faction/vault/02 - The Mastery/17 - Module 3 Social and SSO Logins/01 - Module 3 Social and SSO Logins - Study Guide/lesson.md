...
lesson: "Module 3: Social and SSO Logins — Study Guide"
type: "course_lesson"
post_id: 105098570
space_id: 24191170
source: "https://the-faction.mn.co/posts/105098570"
...
1. Redirect URI whitelisting, the state parameter, and keeping the client secret server-side
1. Minimal scopes, minimal stored profile data, and guarding provider tokens
1. Account linking: one account, many providers, and the email_verified trap
1. Provider risk: outages, deleted provider accounts, and the fallback login path
1. Enterprise SSO: what it buys the buyer, group-to-role mapping, and automatic offboarding
1. Logout separation between your session and the provider's
1. Mobile flow requirements, sandbox testing, and where SSO sits in pricing
...
Ready? Take the [Social and SSO Logins Exam →](https://the-faction.mn.co/posts/the-mastery-module-3-social-and-sso-logins-exam)

---
_Source: https://the-faction.mn.co/posts/105098570_
