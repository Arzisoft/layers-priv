...
lesson: "Module 1: Payments Architecture and Account Setup — Study Guide"
type: "course_lesson"
post_id: 106562714
space_id: 24191170
source: "https://the-faction.mn.co/posts/106562714"
updated: "2026-08-28T15:42:31Z"
---
...
1. Test mode vs live mode boundaries and what does and does not transfer
1. Publishable vs secret vs restricted keys and where each is allowed to live
1. The Customer, PaymentMethod, PaymentIntent, and Charge object relationships
1. PaymentIntent as a state machine for a single collection attempt
1. Direct vs platform (Connect) integration decision criteria
1. Statement descriptors, branding, and dispute prevention at the account level
1. Key rotation and exposure response when a secret key leaks
...
---
_Source: https://the-faction.mn.co/posts/106562714_
