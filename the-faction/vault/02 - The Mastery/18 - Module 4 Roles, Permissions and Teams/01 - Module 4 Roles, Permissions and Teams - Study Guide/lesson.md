...
lesson: "Module 4: Roles, Permissions and Teams — Study Guide"
type: "course_lesson"
post_id: 105098678
space_id: 24191170
source: "https://the-faction.mn.co/posts/105098678"
...
1. Roles versus permissions and keeping the role list small and meaningful
1. Server-side enforcement, per-resource checks, and why hidden buttons secure nothing
1. Default deny as a posture and minimal access for new users
1. Team models: owner powers, safe invitations, and forced ownership transfer
1. Complete revocation on removal and permission changes that bind on the next request
1. Tenant isolation, staff access paths, and impersonation guardrails
1. Audit logging, billing coordination, link sharing, and testing by attempting forbidden actions
...
Ready? Take the [Roles, Permissions and Teams Exam →](https://the-faction.mn.co/posts/the-mastery-module-4-roles-permissions-and-teams-exam)

---
_Source: https://the-faction.mn.co/posts/105098678_
