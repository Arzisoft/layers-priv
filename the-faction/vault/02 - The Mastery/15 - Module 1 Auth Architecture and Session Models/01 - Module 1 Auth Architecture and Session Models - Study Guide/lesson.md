...
lesson: "Module 1: Auth Architecture and Session Models — Study Guide"
type: "course_lesson"
post_id: 105098231
space_id: 24191170
source: "https://the-faction.mn.co/posts/105098231"
...
1. Server sessions versus stateless tokens and the revocation trade-off
1. Cookie flags, localStorage risk, and where secrets must live
1. What real logout, expiry, and session ID regeneration accomplish
1. When a managed auth provider beats building into your own backend
1. Server-side checks on every protected request and CSRF handling
1. Session edge cases: anonymous-to-account upgrades, expiry mid-task, concurrent sessions
1. Testing session handling: expiry, revocation, tampered IDs, and reuse after password change
...
Ready? Take the [Auth Architecture and Session Models Exam →](https://the-faction.mn.co/posts/the-mastery-module-1-auth-architecture-and-session-models-exam)

---
_Source: https://the-faction.mn.co/posts/105098231_
