...
lesson: "Module 6: Password Reset and Edge Cases — Study Guide"
type: "course_lesson"
post_id: 105098995
space_id: 24191170
source: "https://the-faction.mn.co/posts/105098995"
...
1. The anatomy of a safe reset and why existing passwords can never be emailed
1. Token properties: random, expiring, single-use, stored hashed, newest-token-wins
1. Enumeration resistance: identical responses and constant-time behavior
1. Session invalidation on completion and change notifications to the account
1. Scanner-proof consumption and handling expiry mid-form
1. Rate limiting reset floods and handling deactivated accounts
1. Email change, account deletion, lost-email recovery, and dormant account risk
1. Support procedures under pressure, audit logging, and edge-case test passes
...
Ready? Take the [Password Reset and Edge Cases Exam →](https://the-faction.mn.co/posts/the-mastery-module-6-password-reset-and-edge-cases-exam)

---
_Source: https://the-faction.mn.co/posts/105098995_
