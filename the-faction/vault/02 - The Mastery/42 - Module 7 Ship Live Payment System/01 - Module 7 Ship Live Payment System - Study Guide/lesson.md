...
lesson: "Module 7: Ship: Live Payment System — Study Guide"
type: "course_lesson"
post_id: 106562766
space_id: 24191170
source: "https://the-faction.mn.co/posts/106562766"
...
1. Live vs test signing secrets and the classic go-live webhook failure
1. Recreating products, prices, and configuration in live mode
1. Radar calibration: rules, review queue, and dispute rate stakes
1. PCI scope: what keeps a build in SAQ-A and what breaks it
1. Business metric monitoring vs server uptime monitoring
1. Incident response for payment infrastructure: alerts, runbooks, severity
1. Reconciling missed webhook events after endpoint downtime
...
---
_Source: https://the-faction.mn.co/posts/106562766_
