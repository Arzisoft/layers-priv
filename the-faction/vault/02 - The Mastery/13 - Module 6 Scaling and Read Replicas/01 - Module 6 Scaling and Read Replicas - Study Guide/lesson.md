...
lesson: "Module 6: Scaling and Read Replicas — Study Guide"
type: "course_lesson"
post_id: 105097910
space_id: 24191170
source: "https://the-faction.mn.co/posts/105097910"
...
1. Vertical scaling: when it is right, and when its ceiling or availability risk ends it
1. Read replicas, the workloads that move first, and the cost of replicas nobody reads from
1. Replication lag and the read-your-own-writes pattern
1. Connection pooling, write queues and their eventual-consistency trade, and cache invalidation
1. Failover, single points of failure, and tested promotion drills
1. Sharding as a last resort, autoscaling risks, and when doing nothing is correct
1. The complexity cost of added components, and matching the fix to the constraint
...
Ready? Take the [Scaling and Read Replicas Exam →](https://the-faction.mn.co/posts/the-mastery-module-6-scaling-and-read-replicas-exam)

---
_Source: https://the-faction.mn.co/posts/105097910_
