...
lesson: "Module 1: Data Modeling Fundamentals — Study Guide"
type: "course_lesson"
post_id: 105097093
space_id: 24191170
source: "https://the-faction.mn.co/posts/105097093"
...
1. What primary keys do and why generated IDs beat business values like email
1. Choosing correct data types, including decimal for money
1. Clear naming, self-explanatory schemas, and splitting compound fields
1. Constraining values: fixed sets, rejection rules, and when nullable is legitimate
1. Single source of truth, derived values, and keeping files out of the database
1. Timestamps, change attribution, and the schema as a contract
1. Deriving entities from workflows and pressure-testing schemas with real scenarios
...
Ready? Take the [Data Modeling Fundamentals Exam →](https://the-faction.mn.co/posts/the-mastery-module-1-data-modeling-fundamentals-exam)

---
_Source: https://the-faction.mn.co/posts/105097093_
