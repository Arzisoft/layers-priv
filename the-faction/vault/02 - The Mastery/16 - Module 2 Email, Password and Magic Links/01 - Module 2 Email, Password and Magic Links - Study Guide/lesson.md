...
lesson: "Module 2: Email, Password and Magic Links — Study Guide"
type: "course_lesson"
post_id: 105098400
space_id: 24191170
source: "https://the-faction.mn.co/posts/105098400"
...
1. Password policy: length and breach checks over symbol rules, and why caps are wrong
1. Magic link mechanics: single use, short expiry, and the inbox security ceiling
1. Email verification, normalization, and enumeration-resistant flows
1. Rate limiting: progressive slowing versus lockout, and the denial-of-service trade
1. Generic error messages and duplicate-signup handling that reveal nothing
1. Email infrastructure: background queues, sandbox testing, and log hygiene
1. Credential stuffing, SMS trade-offs, security questions, and session invalidation on password change
...
Ready? Take the [Email, Password and Magic Links Exam →](https://the-faction.mn.co/posts/the-mastery-module-2-email-password-and-magic-links-exam)

---
_Source: https://the-faction.mn.co/posts/105098400_
