...
lesson: "Module 5: Two-Factor and Account Security — Study Guide"
type: "course_lesson"
post_id: 105098867
space_id: 24191170
source: "https://the-faction.mn.co/posts/105098867"
...
1. TOTP versus SMS versus email codes, and what passkeys are
1. Where 2FA is mandatory, step-up authentication, and the strongly verified session
1. Backup codes, device trust scope and expiry, and the trusted-device token
1. Library use, encrypted TOTP secret storage, and rate limiting code attempts
1. Recovery design, support verification procedures, and social engineering defense
1. Rolling out mandatory 2FA without chaos and what enrollment must teach
1. Takeover signals, login notifications, and safe security emails
...
Ready? Take the [Two-Factor and Account Security Exam →](https://the-faction.mn.co/posts/the-mastery-module-5-two-factor-and-account-security-exam)

---
_Source: https://the-faction.mn.co/posts/105098867_
